    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <a href="<?php ?>" class = 'btn btn-success'>Thêm mới</a>
                <br><br>
                <table class="table table-success table-striped-columns">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php ?>"><i class="bi bi-pencil"></i>Sửa</a>
                            </td>
                            <td>
                                <form action="<?php ?>" method="post">
                                    <input hidden name="id" type="text" value="<?php ?>"/>
                                        <button class="btn" onclick="return Del('<?php ?>')"><i class="bi bi-trash3"></i>Xóa</button>
                                </form>
                            </td>
                        </tr>
                        <?php 
