<?php   
    ...
    if(isset($_POST['sbm'])){
        ...
        if($query_check->rowCount()>0){
            header('location: index_users.php?error=exists');
        }else{
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form method="post" class="bg-secondary text-light" style="border-radius: 6px; height: 440px">
                <p class="text-white fs-4 fw-semibold" style="padding-top: 10px;">&ensp; Register</p>
                <hr>
                ...
                <div style="margin-left: 10px;">
                    <span class="text-dark">Don't have an account? -</span>&ensp; <a class="link-offset-2 link-underline link-underline-opacity-0 fw-bold" href="index_users.php?page_layout_users=login">Login</a>
                    <br><a class="link-offset-2 link-underline link-underline-opacity-0 text-warning" href="index_users.php?page_layout_users=forgot">Sign Up Forgot your password</a>
                </div>
            </form>
        </div>
        <div class="col-md-4"></div>
