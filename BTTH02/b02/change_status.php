<div class="container-fluid" style="height: 652px;">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <!--  -->
            <form method="post" action="index_admin.php?page_layout_admin=change_status_procces" class="bg-secondary text-light" style="border-radius: 6px; height: 255px">
                <p class="text-white fs-5 fw-semibold" style="padding-top: 10px;">&ensp; Change status</p>
                <hr>
                <div>
