...
<body style="border: 1px solid blue;">
    <?php
        if(isset($_GET['page_layout_users'])){ 
            switch ($_GET['page_layout_users']){
                ...
                case 'forgot':
                    require_once 'b02/forgot.php';
                    break;
                
                case 'send_pass':
                    require_once 'b02/send_pass.php';
                    break;

                case 'reset_password':
                    require_once 'b02/reset_password.php';
                    break;
                
                case 'process_reset_pass':
                    require_once 'b02/process_reset_pass.php';
                    break;
    ...
    <!-- <script src="/b02/PHPMailer/"></script> -->
</body>
</html>